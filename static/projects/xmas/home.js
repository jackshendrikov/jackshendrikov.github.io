...
function createBranch(width, height) {
  ...
  let s = greeting[getRandom(0, greeting.length - 1)].format(
    str[getRandom(0, str.length - 1)]
  );
...
Item.prototype = {
  ...
  touchMoveHandler: function touchMoveHandler(e) {
    ...
    if (touch) {
      return this.update(getCoordinates(touch, this.svg));
    }
  },
};
