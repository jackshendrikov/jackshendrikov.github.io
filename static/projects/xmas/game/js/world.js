class World {
  ...
  renderObjects_() {
    ...
    const bookcaseWidth =
      Config.WORLD_BOOKCASE_WIDTH_PX * Config.WORLD_BOOKCASE_SCALE;
    const bookcaseHeight =
      Config.WORLD_BOOKCASE_HEIGHT_PX * Config.WORLD_BOOKCASE_SCALE;
    ...
    const flowers = this.scene_.physics.add.sprite(
      bookcase.x -
        bookcase.displayWidth / 2 -
        Config.WORLD_FLOWERS_WIDTH_PX / 2 -
        10,
      bookcase.y +
        bookcase.displayHeight / 2 -
    ...
    counterObstacle.displayHeight =
      counter.displayHeight - Config.WORLD_BEHIND_COUNTER_HEIGHT_PX;
    ...
    const zp = this.scene_.add.sprite(
      counter.x - 83,
      Config.WORLD_WALL_TOP_HEIGHT_PX / 2,
      "zp"
    );
    ...
    const harry = this.scene_.add.sprite(
      counter.x - 148,
      Config.WORLD_WALL_TOP_HEIGHT_PX / 2,
      "harry"
    );
    ...
    const carpathians = this.scene_.add.sprite(
      79,
      Config.WORLD_WALL_TOP_HEIGHT_PX / 2,
      "carpathians"
    );
    ...
    const kyiv = this.scene_.add.sprite(
      counter.x + 87,
      Config.WORLD_WALL_TOP_HEIGHT_PX / 2,
      "kyiv"
    );
    ...
    const goverla = this.scene_.add.sprite(
      counter.x + 166,
      Config.WORLD_WALL_TOP_HEIGHT_PX / 2,
      "goverla"
    );
