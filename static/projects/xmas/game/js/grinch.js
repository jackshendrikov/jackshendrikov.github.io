class Grinch {
  constructor(scene, grid, directorState, maxStamina) {
    ...
    this.runSprite_.displayHeight =
      Config.GRINCH_RUN_SPRITE_HEIGHT * Config.GRINCH_RUN_SCALE;
    ...
    this.faintSprite_.displayWidth =
      Config.GRINCH_FAINT_SPRITE_WIDTH * Config.GRINCH_FAINT_SCALE;
    this.faintSprite_.displayHeight =
      Config.GRINCH_FAINT_SPRITE_HEIGHT * Config.GRINCH_FAINT_SCALE;
    ...
    this.faintSprite_.setOrigin(
      ...
      (this.faintSprite_.displayHeight - 5) / this.faintSprite_.displayHeight
    );
  ...
  faint() {
    ...
    this.faintSprite_.x =
      center.x +
      (this.faintSprite_.originX - 0.5) * this.faintSprite_.displayWidth;
    this.faintSprite_.y =
      center.y +
      (this.faintSprite_.originY - 0.5) * this.faintSprite_.displayHeight;
