class Gift {
  ...
  moveToTarget() {
    ...
    this.sprite_.x =
      center.x + Config.GRID_TILE_SIZE_PX / 2 - this.sprite_.displayWidth / 2;
    this.sprite_.y =
      center.y + Config.GRID_TILE_SIZE_PX / 2 - this.sprite_.displayHeight / 2;
  }
  ...
  moveToVictory() {
    ...
    this.sprite_.displayWidth =
      Config.GIFT_WIDTH_PX * Config.GIFT_VICTORY_SCALE;
